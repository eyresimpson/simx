...
use crate::tools::log::direct::shell::basic::success as b_success;
use crate::tools::log::direct::shell::basic::warn as b_warn;
use crate::tools::log::direct::shell::colourful::debug as c_debug;
use crate::tools::log::direct::shell::colourful::err as c_err;
use crate::tools::log::direct::shell::colourful::info as c_info;
use crate::tools::log::direct::shell::colourful::script_err as b_script_err;
use crate::tools::log::direct::shell::colourful::script_err as c_script_err;
use crate::tools::log::direct::shell::colourful::script_log as b_script_log;
